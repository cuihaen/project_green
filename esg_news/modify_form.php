			...
			<div class="writeContent">
				<form  name="board_form" method="post" action="insert.php?mode=modify&num=<?=$num?>&list_style=<?=$list_style?>&page=<?=$page?>&scale=<?=$scale?>"> 
					<div class="writeForm">
						...
						<dl>
							<dt>제목</dt>
							<dd><input class="titleBox" type="text" name="subject" value="<?=$item_subject?>" ></dd>
						</dl>
						<dl class="textBox">
							<dt>내용</dt>
							<dd><textarea class="boardContent" rows="15" cols="79" name="content"><?=$item_content?></textarea></dd>
						</dl>
					</div>
