    ...
    <div id="wrap">
        ...
        <form  name="member_form" method="post" action="insert.php"> 
            ...
            <caption class="hidden">회원가입</caption>
                ...
                <label class="hidden" for="hp2">전화번호중간4자리</label><input type="text" name="hp2" id="hp2" required> - 
                <label class="hidden" for="hp3">전화번호끝4자리</label><input type="text" name="hp3" id="hp3" required>
